      ...
      <Col span={16}>
        ...
        >
          ...
          <Form.Item
            ...
            initialValue={defaultFundraisingTitle}
          >
            <Input />
          </Form.Item>
          <Form.Item
          ...
          >
            <Select placeholder="Choose category" style={{ width: "300px" }} defaultValue={defaultFundraisingType}>
          ...
          <Form.Item
            name={"raise"}
            rules={[{ required: true }]}
            initialValue={defaultFundraisingGoal}
          ...
          <Form.Item
            ...
            rules={[{ required: true }]}
            name={"accountNumber"}
            initialValue={defaultAccountNumber}
          >
            <Input style={{ width: "300px" }} />
          </Form.Item>
          <Form.Item
          ...
          >
            <Form.Item
              ...
              name={"ownerFirstname"}
              style={{ display: "inline-block", width: "calc(50% - 8px)" }}
              initialValue={defaultOwnerFirstName}
            >
              <Input placeholder="First Name" />
            </Form.Item>
            <Form.Item
              ...
              initialValue={defaultOwnerLastName}
            >
              <Input placeholder="Last Name"/>
            </Form.Item>
          </Form.Item>
